        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <Link to="/" className="text-slate-300 hover:text-[#38bdf8] transition-colors text-sm flex items-center gap-2">
                  <Home size={16} /> Home
                </Link>
              </li>
              <li>
                <Link to="/chi-siamo" className="text-slate-300 hover:text-[#38bdf8] transition-colors text-sm flex items-center gap-2">
                  <Building2 size={16} /> L'azienda
                </Link>
              </li>
              <li>
                <Link to="/servizi" className="text-slate-300 hover:text-[#38bdf8] transition-colors text-sm flex items-center gap-2">
                  <FileText size={16} /> Servizi
                </Link>
              </li>
              <li>
                <Link to="/contatti" className="text-slate-300 hover:text-[#38bdf8] transition-colors text-sm flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <Link to="/consulenza-imprese" className="text-slate-300 hover:text-[#38bdf8] transition-colors text-sm">
                  Consulenza Imprese
                </Link>
              </li>
              <li>
                <Link to="/servizi" className="text-slate-300 hover:text-[#38bdf8] transition-colors text-sm">
              ...
              <li>
                <Link to="/ricerca-innovazione" className="text-slate-300 hover:text-[#38bdf8] transition-colors text-sm">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5">
              ...
              <li className="flex items-center gap-3 text-slate-300 text-sm">
                ...
                <a href="mailto:amministrazione@ficohub.it" className="hover:text-[#38bdf8] transition-colors">
