  ...
  head: () => ({
    meta: [
      { title: "Servizi — FI.CO. SRL" },
      {
        name: "description",
        content:
          "Consulenza imprese, gestione enti e permitting, servizi IT: tutti i servizi FI.CO. SRL.",
      },
          ...
          <div style={{ padding: "2.25rem 2.25rem 1.5rem", flexShrink: 0 }}>
            ...
            <div
              style={{
                ...
                height: 1,
                background:
                  "linear-gradient(90deg, rgba(0,153,242,0.3) 0%, rgba(0,153,242,0.05) 100%)",
              }}
            />
          </div>
        ...
        <div className="container-x relative">
          <Reveal>
            ...
            <p className="mt-6 text-lg text-white/75 max-w-2xl">
              Dal design alla messa in esercizio, dalla pratica autorizzativa al supporto operativo:
              una sola filiera.
            </p>
          </Reveal>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                Affianchiamo la tua azienda in ogni fase dello sviluppo delle infrastrutture di
                telecomunicazione. Dalla fattibilità tecnica alla progettazione esecutiva, offriamo
                un supporto su misura per ottimizzare tempi, costi e performance.
              </p>
            ...
            <div className="relative rounded-3xl bg-gradient-to-br from-[#002D4A] to-[#001E35] border border-[#0099f2]/20 p-8 md:p-12 shadow-2xl overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Esperienza sul campo</h3>
                <p className="text-slate-400 leading-relaxed mb-6">
                  Il nostro team di ingegneri e tecnici specializzati garantisce una visione
                  end-to-end. Dai sopralluoghi sul territorio, alla scelta degli apparati
                  trasmissivi, curiamo ogni dettaglio per assicurare un'integrazione perfetta.
                </p>
          ...
          <Reveal>
            <div className="mb-14 flex flex-col gap-3">
              ...
              <p className="text-lg text-gray-300 max-w-2xl">
                Un approccio step-by-step per garantire efficienza, sicurezza e precisione in ogni
                fase della realizzazione dell'infrastruttura in fibra ottica.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <Reveal>
          <div className="mb-10 text-left">
            ...
            <p className="mt-4 text-lg text-slate-300 max-w-2xl">
              ...
              progetti concreti e all'avanguardia.
            </p>
        ...
        <Reveal delay={100}>
          <div className="mt-16 text-left border-t border-white/5 pt-16">
            ...
            <p className="mt-4 text-lg text-slate-300 max-w-2xl leading-relaxed">
              Sviluppiamo interfacce web moderne, performanti e scalabili abbracciando la filosofia
              del <strong className="text-white">vibe coding</strong>: combiniamo l'intelligenza
              artificiale, le migliori tecnologie front-end e la sensibilità creativa per generare
              codice fluido, reattivo e perfettamente in sintonia con l'identità del tuo brand.
            </p>
          </div>
        </Reveal>
      </section>
